---
title: "Get the Registrar Lock of a Domain"
description: "Get the lock state of a domain under your account"
openapi: 'GET https://www.whogohost.com/host/modules/addons/DomainsReseller/api/index.php'
//icon: 'lock'
---
This command is used to get the lock state of a domain under your account.
